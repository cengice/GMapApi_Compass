...
//    private GoogleMap mMap;
    ...
    //mMap.setOnMapLoadedCallback mOnMapLoadedCallback = mMap.OnMapLoadedCallback;
            //() {
    //@Override
/*
    public void onMapLoaded() {
        if (mMap !=null){
       Log.d(TAG, "moveCamera:lane 95 camera to: lat: " + latLng.latitude + ", lng: " + latLng.longitude+ " , zoom" +DEFAULT_ZOOM);
...
//    public LatLng latLng;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if (extras != null) {
                ...
                Log.d(TAG, "moveCamera: lane 83 moving the camera to: lat: " + lat + ", lng: " + lon);
//                latLng = new LatLng(lat, lon);
                Log.d(TAG, "moveCamera: lane 84 moving the camera to: lat: " + latLng.latitude + ", lng: " + latLng.longitude);
